System.register(['./components/Navigation/side-bar.component', '@angular/core', './components/photo/home.component', './components/Navigation/nav-bar.component', '@angular/router-deprecated', './components/UserInfo/register.component', '@angular/http', './services/register.service', './components/UserInfo/login.component', './services/login.service', './services/user.service', './services/photo.service', './components/photo/my-album.component', './components/photo/add-photo.component', './components/photo/image-detail.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var side_bar_component_1, core_1, home_component_1, nav_bar_component_1, router_deprecated_1, router_deprecated_2, register_component_1, http_1, register_service_1, login_component_1, login_service_1, user_service_1, photo_service_1, my_album_component_1, add_photo_component_1, image_detail_component_1;
    var AppComponent;
    return {
        setters:[
